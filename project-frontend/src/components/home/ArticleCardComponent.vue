...
// Función para truncar el contenido a 10 caracteres
        ...
        <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700"
          ...
          <div class="p-5">
            ...
            <div class="flex items-center justify-between">
              <p class="font-normal text-gray-700 mb-3 dark:text-gray-400">{{ article.content }}</p>
              <a :href="article.url"
