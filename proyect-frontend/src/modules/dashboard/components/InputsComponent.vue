    ...
    <div class="w-full bg-white shadow-xl rounded-lg flex overflow-x-auto custom-scrollbar">
                        ...
                        <div class="flex-1 px-2">
                            <div class="h-16 flex items-center">
                                <h4 class="text-lg font-bold">New Article</h4>
                            </div>
                            <div class="mb-6 pt-4">
                                <div>
                                ...
                                <div>
                                    <textarea id="body" class="w-full h-64 text-gray-700 border-b border-b-gray-300 focus:outline-none focus:ring-0 focus:border-transparent focus:border-b-gray-300" placeholder="Content..."></textarea>
                                </div>
                                <div class="flex items-center justify-between mt-4">
                                    <div class="flex items-center space-x-2">
                                        <button class="bg-blue-500 hover:bg-blue-700 rounded-lg px-12 py-1.5 text-gray-100 hover:shadow-xl transition duration-150">Save</button>
                                    </div>
